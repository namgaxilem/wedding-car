...
export default function CarDetail({ carDocumentId }: Props) {
  ...
  useEffect(() => {
    ...
    http
      .get(
        `${apiPath}/${carDocumentId}?populate=thong_tin_xe_common.hinh_xe_dai_dien&populate=thong_tin_xe_common.hinh_xe`
      )
      .then(({ data }: any) => {
        setCar(data);
      })
              ...
              <div className="w-full md:w-1/2 px-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700">
                    <li>Điều hòa mát lạnh</li>
                    <li>Màn hình cảm ứng</li>
                    <li>Loa thanh sống động</li>
